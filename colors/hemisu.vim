...
if version >= 700
	...
	call s:h("ColorColumn", { "bg": s:almostBlack })
...
call s:h("IncSearch",    { "bg": s:faintBlue, "fg": s:bg})
call s:h("Search",       { "bg": s:faintBlue, "fg": s:bg})
...
call s:h("ToLong",       { "fg": s:almostBlack, "bg": s:accent2 })
